...
country = {
	...
	GOLD_TO_CASH_RATE = 0.01, -- Amount of money generated per gold unit
...
economy = {
	...
	FACTORY_PAYCHECKS_LEFTOVER_FACTOR = 0.60, -- % of how much we pay to the pops and capitalists, from the leftovers.
