...
country = {
	...
	GOLD_TO_CASH_RATE = 0.10, -- Amount of money generated per gold unit
	...
	BADBOY_LIMIT = 50,
	MAX_BUREAUCRACY_PERCENTAGE = 0.020, -- More than max percent bureaucrats of population will give no additional benefits
	BUREAUCRACY_PERCENTAGE_INCREMENT = 0.000, -- For each social administrative reform level, this is added to MAX_BUREAUCRACY_PERCENTAGE
	...
	BASE_TARIFF_EFFICIENCY = 0.50, -- baseline tariff efficiency
...
economy = {
	...
	BANKRUPTCY_FACTOR = 0.20,
	SHADOWY_FINANCIERS_MAX_LOAN_AMOUNT = 500000,
	MAX_LOAN_CAP_FROM_BANKS = 250, -- can loan max % of country tax base from single country
	...
	NUM_CLOSED_FACTORIES_PER_STATE_LASSIEZ_FAIRE = 0, -- Number of closed factories allowed per state under Laissez Faire
...
military = {
	...
	SIEGE_BRIGADES_MAX = 5, -- the number of brigades above which you get no addition benefit in sieges
...
diplomacy = {
	...
	INFAMY_ADD_TO_SPHERE = 1, -- 2
	INFAMY_RELEASE_PUPPET = 1.0, -- 0.5
	INFAMY_MAKE_PUPPET = 1, -- 5
	INFAMY_DISARMAMENT = 1, -- 5
	INFAMY_DESTROY_FORTS = 1.0, -- 0.5
	INFAMY_DESTROY_NAVAL_BASES = 1, -- 2
	INFAMY_REPARATIONS = 1, -- 5
	INFAMY_TRANSFER_PROVINCES = 1, -- 3
	INFAMY_REMOVE_CORES = 1, -- 0
	INFAMY_PRESTIGE = 1, -- 2
	INFAMY_CONCEDE = 1, -- 1
	INFAMY_STATUS_QUO = 1, -- 0
	INFAMY_ANNEX = 1, -- 10
	INFAMY_DEMAND_STATE = 1, -- 5
	INFAMY_INSTALL_COMMUNIST_GOV_TYPE = 1, -- 5
	INFAMY_UNINSTALL_COMMUNIST_GOV_TYPE = 1, -- 5
	INFAMY_COLONY = 1, -- 5
...
pops = {
	...
	BASE_GOODS_DEMAND = 0.5,
	BASE_POPGROWTH = 0.0001,
	MIN_LIFE_RATING_FOR_GROWTH = 29,
	LIFE_RATING_GROWTH_BONUS = 0.00010,
