...
diplomacy = {
	...
	INFAMY_ADD_TO_SPHERE = 0, -- 2
	INFAMY_RELEASE_PUPPET = 0.0, -- 0.5
	INFAMY_MAKE_PUPPET = 0, -- 5
	INFAMY_DISARMAMENT = 0, -- 5
	INFAMY_DESTROY_FORTS = 0.0, -- 0.5
	INFAMY_DESTROY_NAVAL_BASES = 0, -- 2
	INFAMY_REPARATIONS = 0, -- 5
	INFAMY_TRANSFER_PROVINCES = 0, -- 3
	INFAMY_REMOVE_CORES = 0, -- 0
	INFAMY_PRESTIGE = 0, -- 2
	INFAMY_CONCEDE = 0, -- 1
	INFAMY_STATUS_QUO = 0, -- 0
	INFAMY_ANNEX = 0, -- 10
	INFAMY_DEMAND_STATE = 0, -- 5
	INFAMY_INSTALL_COMMUNIST_GOV_TYPE = 0, -- 5
	INFAMY_UNINSTALL_COMMUNIST_GOV_TYPE = 0, -- 5
	INFAMY_COLONY = 0, -- 5
